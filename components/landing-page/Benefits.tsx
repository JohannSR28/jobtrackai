        ...
        <div className="max-w-[1200px] mx-auto px-6 relative z-10 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-20 text-left">
            {[
              {
                title: "GAIN DE TEMPS",
                desc: "Fini les fichiers Excel manuels. Tout est automatisé.",
              },
              { title: "CENTRALISATION", desc: "Tout au même endroit." },
              {
                title: "NOTIFICATIONS",
                desc: "Soyez alerté dès qu'un recruteur vous répond.",
              },
          ...
          <div className="relative bg-white w-full max-w-md rounded-2xl shadow-2xl p-8 animate-fade-in border border-gray-100">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500 text-sm">
                Entrez vos coordonnées pour débloquer 500 crédits.
              </p>
            </div>
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                className="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 font-medium focus:outline-none focus:border-brand-orange focus:ring-1 focus:ring-brand-orange"
              />
              <input
                type="email"
              ...
              <button
                type="submit"
                className="w-full bg-gen-black text-white font-bold py-4 rounded-xl hover:bg-gray-900 transition-colors uppercase tracking-wide text-sm"
              >
                Confirmer l&apos;inscription →
              </button>
            </form>
            <p className="text-center text-[10px] text-gray-400 mt-6">
              En cliquant, vous acceptez nos conditions.
            </p>
          </div>
        </div>
      )}
