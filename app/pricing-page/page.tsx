...
const translations = {
  fr: {
    ...
    a1: "Chaque crédit vous permet de tracker une candidature.",
    ...
    a3: "Si vous supprimez votre compte, vous gardez vos crédits restants. Aucun remboursement n'est possible.",
    goBack: "← Retour",
  },
  en: {
    ...
    a1: "Each credit allows you to track an application.",
    q2: "Do credits expire?",
    a2: "No, your credits never expire. Use them at your own pace.",
    q3: "What happens if I delete my account?",
    a3: "If you delete your account, you keep your remaining credits. No refunds are possible.",
    goBack: "← Back",
  },
};
